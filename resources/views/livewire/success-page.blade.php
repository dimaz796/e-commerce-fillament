<section class="flex items-center font-poppins dark:bg-gray-800 py-10 px-6">
    <div
        ...
        <div>
                    ...
                    <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                        <div class="flex flex-col items-start justify-start space-y-2">
                            ...
                            <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                                {{ $order->address->street_address }}s</p>
            ...
            <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
                ...
                <a href="/my-orders"
                    class="w-full text-center px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-auto dark:text-gray-300 hover:bg-blue-600 dark:hover:bg-blue-900 dark:bg-blue-800">
                    View My Orders
                </a>
            </div>
        </div>
