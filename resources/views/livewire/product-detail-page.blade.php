                ...
                <div class="w-full px-4 md:w-1/2">
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc">
                            <h2 class="max-w-xl mb-6 text-2xl font-bold text-gray-900 dark:text-gray-100 md:text-4xl">
                                {{ $product->name }}
                            </h2>
                        ...
                        <div class="w-32 mb-8">
                            <label
                                class="w-full pb-1 text-xl font-semibold text-gray-900 border-b border-blue-300 dark:border-gray-500 dark:text-gray-100">
                                Quantity
                            </label>
