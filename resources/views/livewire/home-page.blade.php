            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600 dark:text-blue-400">DCodeMania</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase wide varieties of electronics
                        products like Smartphones, Laptops, Smartwatches, Television and many more.</p>

                    <!-- Buttons -->
                    <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:bg-blue-500 dark:hover:bg-blue-600"
                            href="/register">
                            Get started
                        ...
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800"
                            href="/contact">
                            Contact sales team
                        </a>
                    </div>
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                <!-- Star Icons -->
                                <svg class="h-4 w-4 text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <polygon
                                        points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                                </svg>
                                <!-- Tambah lebih banyak SVG bintang di sini jika diperlukan -->
                            </div>
                            ...
                            <div class="mt-5">
                                <!-- Logo -->
                                <svg class="h-auto w-16 text-gray-800 dark:text-white" viewBox="0 0 80 27"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <text x="0" y="20" font-size="18" fill="currentColor">Google</text>
                                </svg>
                            </div>
                        </div>
                        ...
                        <div class="py-5">
                            ...
                            <div class="mt-5">
                                <!-- Logo -->
                                <svg class="h-auto w-16 text-gray-800 dark:text-white" viewBox="0 0 110 28"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <text x="0" y="20" font-size="18" fill="currentColor">Forbes</text>
                                </svg>
                            </div>
                        </div>
                    </div>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                @foreach ($categories as $category)
                    <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-800 dark:border-gray-700 dark:hover:shadow-lg dark:focus:outline-none dark:focus:ring-2 dark:focus:ring-slate-600"
                        ...
                        <div class="p-4 md:p-5">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-3">
                                        <h3
                                            class="group-hover:text-blue-600 font-semibold text-gray-800 dark:group-hover:text-blue-400 dark:text-gray-200">
                                            {{ $category->name }}</h3>
                                    </div>
                                </div>
                                <div class="ps-3">
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-800 dark:text-gray-400"
