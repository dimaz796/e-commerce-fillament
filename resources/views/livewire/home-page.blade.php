<div>
    <div class="w-full h-screen bg-gradient-to-r from-gray-100 to-blue-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Grid -->
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1 class="block text-3xl font-bold text-gray-900 sm:text-4xl lg:text-6xl lg:leading-tight">
                        Start your journey with <span class="text-blue-600">Dimas</span></h1>
                    <p class="mt-3 text-lg text-gray-600">Purchase wide varieties of electronics
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                <svg class="h-4 w-4 text-gray-900" width="51" height="51" viewBox="0 0 51 51"
                                ...
                                <!-- Tambahkan bintang lain untuk rating -->
                            </div>
        ...
        <div class="max-w-xl mx-auto">
            <div class="text-center">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold text-gray-900">Browse Popular<span class="text-blue-500">
                            Brands</span>
                    </h1>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    ...
                    numquam,
                    odio quod nobis ipsum ex cupiditate?
                </p>
            </div>
        </div>
    ...
    <div class="bg-blue-50 py-20">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8">
                <a class="group flex flex-col bg-white border border-blue-100 shadow-sm rounded-xl hover:shadow-md transition hover:border-blue-500"
                    href="#">
                    <div class="p-4 md:p-5">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="ps-3">
                                <svg class="flex-shrink-0 w-5 h-5 text-blue-500 group-hover:text-blue-600"
